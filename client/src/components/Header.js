                ...
                <div className="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
                    <div className="relative flex items-center justify-between h-16">
                        ...
                        <div className=" flex items-center justify-center sm:items-stretch sm:justify-start w-full">
                            ...
                            <div className="text-sm text-gray-300 flex-grow hidden sm:block">
                                <div className="justify-center flex ">
                                    {showFileStatus && (
                                        <div className="flex flex-col p-3 flex-shrink">
                                            <div className="items-center my-auto h-5 font-semibold truncate flex-shrink">
                                                {currentFile}
                                            </div>

                                            {isAutoSaving ? (
                                                <div className=" my-auto items-center text-gray-300 flex-shrink">
