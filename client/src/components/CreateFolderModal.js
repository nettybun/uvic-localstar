...
import { createFolderDispatch } from "../redux/actions/projectActions";
import { useDispatch } from "react-redux";
import { useState } from "preact/hooks";

const CreateFolderModal = ({ showModal, setShowModal, id }) => {
    ...
    const onClick = () => {
        dispatch(createFolderDispatch(folderName, id));
        setFolderName("");
        setShowModal(false);
    };
    ...
    return (
        <Modal show={showModal}>
            <div className="p-5">
                ...
                <div class="font-bold text-3xl py-3">Create Folder</div>
